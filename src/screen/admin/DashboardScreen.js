...
const DashboardScreen = ({navigation}) => {
    ...
    return <MyContainer screencontainer>
                ...
                <Spacer spacer/>
                <MyCardList iconName="list-ul" title="Visit Request Today" button="View Visitor"  details={admindashboardobj.visitRequestList} func={() => navigation.navigate('Visit Request List')}/>
                </ScrollView>
            </MyContainer>
};
